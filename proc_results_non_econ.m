...
%                     k=6;
%                                              
%                 filename=strcat('C:\Users\AU289559\Documents\MATLAB\science\partialrez\', int2str(MWTYPE));
%                 filename=strcat(filename, int2str(CTYPE));
%                 filename=strcat(filename, int2str(LSTYPE));
%                 filename=strcat(filename, int2str(FORSIGHT));
%                 filename=strcat(filename, int2str(ECON));
    ...
    for CTYPE=1:2
        for LSTYPE=1:2
            for FORSIGHT=0:2:2
                ...
                filename=strcat('C:\Users\AU289559\Documents\MATLAB\science\partialrez\mw\', int2str(MWTYPE));
